/** Root directory for dsh-tower state (avoids colliding with Kimi `.tower`). */
export const TOWER_ROOT = '.dsh-tower';
...
/** Isolated mission worktrees live under `.dsh-tower/worktrees/wt-N` (not `.dsh-worktrees/`). */
...
/** Protocol name for the main/tower agent (inbox addressing). */
